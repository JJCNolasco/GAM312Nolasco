...
public:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		UObjectiveWidget* objWidget; // Reference to the objective UI widget

	UPROPERTY()
		float objectsBuilt; // Counter for built objects

	UPROPERTY()
		float matsCollected; // Counter for collected materials
